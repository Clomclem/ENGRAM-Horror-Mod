...
// Copy of entity navigation
public class Blueice129Navigation {
        ...
        protected PlayerPathNodeMaker nodeMaker;
        @Nullable
        private BlockPos currentTarget;
        private int currentDistance;
        private float rangeMultiplier = 1.0F;
        private final PlayerPathNodeNavigator pathNodeNavigator;
        private boolean nearPathStartPos;

        public Blueice129Navigation(Blueice129Entity entity, World world) {
            this.entity = entity;
            this.world = world;
        ...
        protected PlayerPathNodeNavigator createPathNodeNavigator(int range) {
            this.nodeMaker = new PlayerLandPathNodeMaker();
            this.nodeMaker.setCanEnterOpenDoors(true);
            return new PlayerPathNodeNavigator(this.nodeMaker, range);
        }
    ...
    public Path findPathTo(BlockPos target, int distance) {
        if (this.world.getBlockState(target).isAir()) {
            ...
            if (blockPos.getY() > this.world.getBottomY()) {
                return superFindPathTo(blockPos.up(), distance);
            }
        ...
        if (!this.world.getBlockState(target).isSolid()) {
            return superFindPathTo(target, distance);
        } else {
            ...
            return superFindPathTo(blockPos, distance);
        }
    }

        @Nullable
        public Path superFindPathTo(BlockPos target, int distance) {
    ...
    protected boolean isInLiquid() {
        ...
        public PlayerPathNodeMaker getNodeMaker() {
