...
public abstract class PlayerPathNodeMaker {
    protected ChunkCache cachedWorld;
    protected Blueice129Entity entity;
     ...
     */
    public abstract PathNodeType getNodeType(BlockView world, int x, int y, int z, Blueice129Entity mob);
