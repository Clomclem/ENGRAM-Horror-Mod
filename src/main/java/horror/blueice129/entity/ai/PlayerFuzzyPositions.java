...
public class PlayerFuzzyPositions {
     ...
     */
    @Nullable
    public static Vec3d guessBestPathTarget(Blueice129Entity entity, Supplier<BlockPos> factory) {
     ...
     * if it exists.
     */
    public static BlockPos towardTarget(Blueice129Entity entity, int horizontalRange, Random random, BlockPos fuzz) {
        int i = fuzz.getX();
        int j = fuzz.getZ();
